...
namespace ofxModule {
	...
	public:
		...
		void notifyEvent(string address, ofJson message = ofJson(),string destClass="");
		/// \brief notification of other modules
		void notifyEvent(shared_ptr<ofTexture> texture, string address = "texture", ofJson message = ofJson(), string destClass = "");
		/// \brief notification of other modules
		void notifyEvent(shared_ptr<ofImage> image, string address = "image", ofJson message = ofJson(), string destClass = "");
		/// \brief notification of other modules
		void notifyEvent(shared_ptr<ofFbo> fbo, string address = "fbo", ofJson message = ofJson(), string destClass = "");
		/// \brief notification of other modules
		void notifyEvent(shared_ptr<ofPixels> pixels, string address = "pixels", ofJson message = ofJson(), string destClass = "");
		/// \brief notification of other modules
		void notifyEvent(vector<shared_ptr<ofTexture>> textures, string address = "textures", ofJson message = ofJson(), string destClass = "");
		/// \brief notification of other modules
		void notifyEvent(vector < shared_ptr<ofImage>> images, string address = "images", ofJson message = ofJson(), string destClass = "");
		/// \brief notification of other modules
		void notifyEvent(vector<shared_ptr<ofFbo>> fbo, string address = "fbos", ofJson message = ofJson(), string destClass = "");
